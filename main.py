...
def parse_args():   
    ...
    parser.add_argument('--penalty_coeff', type=float, default=10) 
    ...
    parser.add_argument('--alpha', type=float, default=0.1, help='Dirichlet concentration parameter for environment augmentation')
